...
const Home = () => {
  return (
    <section
      id="home"
      className="px-4 lg:px-14 py-6 lg:py-14 flex justify-center items-center h-[34rem] lg:h-[42rem]"
    >
      <SocialMediaIcons />
      <div className="flex flex-col items-center">
        ...
        <h3 className="pb-6 lg:pb-8 text-center text-grey-100 max-w-xl leading-8 lg:leading-10 lg:text-lg">
